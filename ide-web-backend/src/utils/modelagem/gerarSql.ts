import type { Coluna, ModeloLogico, Tabela } from '../../dtos/modelagem.schema';
import { TIPOS_INTEIROS } from '../../dtos/modelagem.schema';
 ...
 * `ide-web-front/src/features/exercicio/modelagem/gerarSql.ts` — mantenha as duas iguais e com
...
export function gerarSql(logico: ModeloLogico): SqlGerado {
  ...
  preparadas.forEach((tabela) => {
    validarColunas(tabela, avisos);
  });
